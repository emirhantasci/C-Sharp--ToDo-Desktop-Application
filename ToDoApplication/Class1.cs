...
namespace ToDoApplication
{
    class Veritabani
    {
        SqlConnection SQLBaglantisi = new SqlConnection("Data Source=.;Initial Catalog=ToDoProject;Integrated Security=True");
        string girisDurumu;
        string sifreDurumu;
        ...
        public string girisSorgula(string _kayitId, string _kayitSifre)
        {
            ...
            giris.Parameters.AddWithValue("kullaniciAdi", sorgumm.ToString());
